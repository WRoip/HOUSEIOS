...
GPIO_InitTypeDef GPIO_InitStruct_DHT;
...
void DHT11_Init()
{
	...
	//配置GPIOG
	GPIO_InitStruct_DHT.GPIO_Mode	= GPIO_Mode_OUT;
	GPIO_InitStruct_DHT.GPIO_OType	= GPIO_OType_PP;
	GPIO_InitStruct_DHT.GPIO_Pin	= GPIO_Pin_9;
	GPIO_InitStruct_DHT.GPIO_PuPd	= GPIO_PuPd_UP;
	GPIO_InitStruct_DHT.GPIO_Speed	= GPIO_Speed_50MHz;
